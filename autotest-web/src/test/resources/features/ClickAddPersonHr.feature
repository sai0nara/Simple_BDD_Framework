#language:ru
@clickAddPersonHr
Функция: Проверка работоспособности ссылки "Сотрудники" по аккаунтом "hr"
  ...
  проверка текста в инфоблоке, после нажатия на кнопку "Сотрудники"
    ...
    Если кнопка 'Добавить поле Сотрудники' отображается
    Тогда нажать на кнопку 'Добавить поле Сотрудники'
    Если поле 'Заголовок таблицы' отображается
    Тогда проверить поле 'Заголовок таблицы', что текст в поле 'Добавить Сотрудник'