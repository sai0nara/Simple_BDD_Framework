...
public class EmployeeInfoblockTest extends WebHooks {
    ...
    public Object[][] data() {
        return new Object[][]{
                {"hr", "Сотрудники", "Инфоблок", "Выберите Сотрудник для изменения"},
                {"hr", "Добавить поле Сотрудники", "Инфоблок", "Добавить Сотрудник"},
                {"public", "Сотрудники", "Инфоблок", "Выберите Сотрудник для просмотра"}
        };
    }
