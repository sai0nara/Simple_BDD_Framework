...
public class KeySkillTypesTest {
    ...
    public void testPost() {
        apiSteps.postForKeySkillTypes("key_skill_types", "qwerqwerqwer500");
    }

    @Test(priority = 3)
    public void testPatch() {
        apiSteps.patchForKeySkillTypes("key_skill_types","qwerqwerqwer9000", "qwarqwarqwar10000");
    }

    @Test(priority = 4)
    public void testDelete() {
        apiSteps.deleteForKeySkillTypes("key_skill_types", "qwarqwarqwar5000");
    }
